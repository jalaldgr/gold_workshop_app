...
import '../../helper/designerApi.dart';
...
class _DesignerProfileScreenState extends State<DesignerProfileScreen> {
  ...
  Future<userData> fetchUserData() async {
    ...
    final response = await http.get(
        Uri.parse('${dotenv.env['API_URL']}/designer/get-designer/$userID'),
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  // Save new journal
                userData userUpdated =new  userData(user.username, fullNameController.text,"Designer",user.id,passwordController.text);
                String response = await DesignerApi.updateDesigner(userUpdated);
