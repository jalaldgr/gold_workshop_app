...
class ShowOrderScreen extends StatefulWidget {
  orderData order;
  ShowOrderScreen({super.key,required this.order});

  @override
  ShowOrderScreenState createState() {
    return ShowOrderScreenState();
  }
}
...
class ShowOrderScreenState extends State<ShowOrderScreen> {
  ...
  var statusDropDownItems = ['در انتظار بررسی','تکمیل نهایی' , 'ارسال به طراح','','برگشت از طراح','برگشت از کارگاه' ,'لغو شده'];
