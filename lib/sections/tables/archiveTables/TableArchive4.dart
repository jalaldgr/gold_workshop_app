...
class Table4ArchiveScreen extends StatefulWidget {
  final Color headerColor;
  final tableData table;

  const Table4ArchiveScreen({Key? key, required this.headerColor, required this.table}) : super(key: key);

  @override
  _Table4ArchiveScreenState createState() => _Table4ArchiveScreenState();
}

class _Table4ArchiveScreenState extends State<Table4ArchiveScreen> {
  ...
  updateTable() async {
    ...
    tableData t = new tableData("تکمیل کارگاه 1", "", "", "",jsonEncode(table41), "", "", "","","","",widget.table.id);
    ...
    tableData t42 = new tableData("تکمیل کارگاه 1", "", "", "","", jsonEncode(table42), "", "","","","",widget.table.id);
    var respo42 = await AdminApi.postTableById(t42);
  }
  ...
  fetchTable() async {
    ...
    if(tables.table42!.length>10){
      ...
      List description = table1["description"];
      List yesterday_balance = table1["yesterday_balance"];
  ...
  calculateTableB()async{
    ...
    tableData t = new tableData("تکمیل کارگاه 1","","", "", jsonEncode(table41),jsonEncode(table42),"", "","","","",widget.table.id);
    var respo = await AdminApi.postTableById(t);
