...
class Table5ArchiveScreen extends StatefulWidget {
  final Color headerColor;
  final tableData table;

  const Table5ArchiveScreen({Key? key, required this.headerColor, required this.table}) : super(key: key);

  @override
  _Table5ArchiveScreenState createState() => _Table5ArchiveScreenState();
}

class _Table5ArchiveScreenState extends State<Table5ArchiveScreen> {
  ...
  updateTable()async{
    ...
    tableData t = new tableData("تکمیل کارگاه 1", "", "", "","", "", jsonEncode(table5), "","","","",widget.table.id);
