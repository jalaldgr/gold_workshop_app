...
class Table3ArchiveScreen extends StatefulWidget {
  final Color headerColor;
  final tableData table;
  const Table3ArchiveScreen({Key? key, required this.headerColor, required this.table}) : super(key: key);

  @override
  _Table3ArchiveScreenState createState() => _Table3ArchiveScreenState();
}

class _Table3ArchiveScreenState extends State<Table3ArchiveScreen> {
  ...
  updateTable() async {
    ...
    tableData t = new tableData("تکمیل کارگاه 2", "", "", jsonEncode(table3), "","", "", "","","","",widget.table.id);
