...
import 'showWorkshop2Order.dart';



class Workshop2OrdersList extends StatefulWidget {
  const Workshop2OrdersList({Key? key}) : super(key: key);

  @override
  _Workshop2OrdersListState createState() => _Workshop2OrdersListState();
}

class _Workshop2OrdersListState extends State<Workshop2OrdersList> {
                ...
                Column(children: [
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Expanded(child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [Text("نام طراح",style: TextStyle(fontSize: 11),),Text("${order!.designerFullName}")],)),
