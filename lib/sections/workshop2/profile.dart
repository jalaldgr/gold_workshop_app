...
class Workshop2ProfileScreen extends StatefulWidget {
  @override
  _Workshop2ProfileScreenState createState() => _Workshop2ProfileScreenState();
}

class _Workshop2ProfileScreenState extends State<Workshop2ProfileScreen> {
  ...
  Future<userData> fetchUserData() async {
    ...
    final response = await http.get(
        Uri.parse('${dotenv.env['API_URL']}/workshop2/get-workshop2/$userID'),
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  // Save new journal
                userData userUpdated =new  userData(user.username, fullNameController.text,"Workshop2",user.id,passwordController.text,"");
                String response = await Workshop2Api.updateWorkshop2(userUpdated);
